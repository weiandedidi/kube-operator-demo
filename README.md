...
#查询开发机的状态
curl --location 'http://localhost:8080/api/v1/devmachines/status?name=my-devmachine&namespace=taskmodeling-public-prod'

# 删除开发机
curl --location 'http://localhost:8080/api/v1/devmachines/delete?name=my-devmachine&namespace=taskmodeling-public-prod'
```
